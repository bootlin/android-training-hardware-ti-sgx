...
# Auto-generated for omap4430_android from build: sgxddk_1.8@789263
#

# PVR Consumer services version number
#
PVRVERSION="sgxddk_1.8@789263"
...
install_pvr()
{
	$DOIT echo "version sgxddk_1.8@789263" >${DISCIMAGE}${DDK_INSTALL_LOG}
...
echo
echo "Installing PowerVR Consumer/Embedded DDK 'sgxddk_1.8@789263' on $from"
echo
