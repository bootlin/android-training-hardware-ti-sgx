...
KBUILD_WARNING_CFLAGS += \
 $(call cc-optional-warning,-Wbad-function-cast) \
 $(call cc-optional-warning,-Wcast-qual) \
 $(call cc-optional-warning,-Wcast-align) \
 $(call cc-optional-warning,-Wconversion) \
 $(call cc-optional-warning,-Wdisabled-optimization) \
 $(call cc-optional-warning,-Wlogical-op) \
 $(call cc-optional-warning,-Wmissing-declarations) \
 $(call cc-optional-warning,-Wmissing-include-dirs) \
 $(call cc-optional-warning,-Wnested-externs) \
 $(call cc-optional-warning,-Wold-style-definition) \
 $(call cc-optional-warning,-Woverlength-strings) \
 $(call cc-optional-warning,-Wpacked) \
 $(call cc-optional-warning,-Wpacked-bitfield-compat) \
 $(call cc-optional-warning,-Wpadded) \
 $(call cc-optional-warning,-Wredundant-decls) \
 $(call cc-optional-warning,-Wshadow) \
 $(call cc-optional-warning,-Wswitch-default) \
 $(call cc-optional-warning,-Wvla) \
 $(call cc-optional-warning,-Wwrite-strings)
...
ALL_KBUILD_CFLAGS := $(COMMON_CFLAGS) $(KBUILD_WARNING_CFLAGS) \
 ...
 $(call cc-option,-Wno-pointer-arith) \
 $(call cc-option,-Wno-aggregate-return)
